...
m_rank = 4:4:28; % housing

nsamples = 5;     % number of samples in resampling
sigma = 0;
...
% saveas(smse, '../figs/housing_smse_rank.pdf');
% saveas(smse, '../figs/housing_mnlp_rank.pdf');
